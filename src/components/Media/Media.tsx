import "../../../node_modules/@iiif/thumbnail-panel/dist/style.css";

import React, { useEffect, useState } from "react";
import { Group, MediaStyled } from "@/components/Media/Media.styled";
...
const Media: React.FC<MediaProps> = ({ items }) => {
  ...
  const { activeCanvas, activeManifest, vault } = state;
  ...
  const handleOnResourceChanged = (canvasId: string) => {
  ...
  return (
    <MediaStyled>
      <ThumbnailPanel
        ...
        onResourceChanged={handleOnResourceChanged}
      />
    </MediaStyled>
  );
};
